...
// this for now is "not really" implemented
// ... since the police is more of an test object
// TODO: enable sightcone/minimap for separate players and views
// TODO: police sightcone is now simply disabled - render camera accordingly that only specific lights/cones are visible
// TODO thorsten: do further work on sightcones, maybe alternatives to simple light
public class PoliceSightConeController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // ... this is however (for now of no use, since we have no real multiplayer)
